...
QByteArray DynaMsgParser::generateAuthRequest(QString name)
{
...
QByteArray DynaMsgParser::generateAuthReply(quint64 id)
{
...
//		emit jsonPacketReceived(topobject);
	...
	{
		//Auth response from the other party, will contain capabilities of the connected client.
		QJsonDocument doc = QJsonDocument::fromJson(packet.mid(20));
		QJsonObject topobject = doc.object();
